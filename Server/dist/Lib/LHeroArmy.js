...
class LHeroArmy {
    static filledPlacesSize(idHero) {
        return __awaiter(this, void 0, void 0, function* () {
            const HeroArmy = yield Elkaisar.DB.ASelectFrom("*", "hero_army", "id_hero = ?", [idHero]);
    ...
    static heroFullCap(idPlayer, idHero) {
        return __awaiter(this, void 0, void 0, function* () {
            const Hero = yield Elkaisar.DB.ASelectFrom("hero.point_a, hero.point_a_plus, hero_medal.*, hero.id_city", "hero JOIN hero_medal ON hero.id_hero = hero_medal.id_hero", "hero.id_hero = ?", [idHero]);
            const PlayerEdu = yield Elkaisar.DB.ASelectFrom("leader", "player_edu", "id_player = ?", [idPlayer]);
            const AcadmyLvl = (yield Elkaisar.Lib.LCityBuilding.buildingWithHeighestLvl(Hero[0]["id_city"], Elkaisar.Config.CITY_BUILDING_ACADEMY))["Lvl"];
    ...
    static emptyPlacesSize(idPlayer, idHero) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield LHeroArmy.heroFullCap(idPlayer, idHero)) - (yield LHeroArmy.filledPlacesSize(idHero));
        });
    }
    isCarringArmy(idHero) {
        return __awaiter(this, void 0, void 0, function* () {
            const Army = yield Elkaisar.DB.ASelectFrom("*", "hero_army", "id_hero = ?", [idHero]);
            if (!Array.isArray(Army) || !Army[0])
                return false;
            this.HArmy = Army;
            if (Army[0]["f_1_num"] > 0 || Army[0]["f_2_num"] > 0 || Army[0]["f_3_num"] > 0
    ...
    isTheSame(arymType) {
        if (!this.HArmy[0])
            return false;
        if (this.HArmy[0]["f_1_type"] != 0 && this.HArmy[0]["f_1_type"] != arymType)
            return false;
        else if (this.HArmy[0]["f_2_type"] != 0 && this.HArmy[0]["f_2_type"] != arymType)
            return false;
        else if (this.HArmy[0]["f_3_type"] != 0 && this.HArmy[0]["f_3_type"] != arymType)
            return false;
        else if (this.HArmy[0]["b_1_type"] != 0 && this.HArmy[0]["b_1_type"] != arymType)
            return false;
        else if (this.HArmy[0]["b_2_type"] != 0 && this.HArmy[0]["b_2_type"] != arymType)
            return false;
        else if (this.HArmy[0]["b_3_type"] != 0 && this.HArmy[0]["b_3_type"] != arymType)
            return false;
        return true;
    }
