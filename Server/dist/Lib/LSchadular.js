...
Elkaisar.Base.ResetWorldLvl = function (UnitList) {
...
Elkaisar.Base.DailyReset = function () {
...
Elkaisar.Cron.schedule("51 * * * *", function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const Teams = yield Elkaisar.DB.ASelectFrom("id_team", "team", "1");
...
Elkaisar.Cron.schedule("47 * * * *", function () {
    Elkaisar.DB.QueryExc(`UPDATE hero SET in_city = ${Elkaisar.Config.HERO_IN_CITY} WHERE id_hero NOT IN( SELECT id_hero FROM battel_member) AND id_hero NOT IN(SELECT id_hero FROM hero_back)`, [], function () {
