...
Elkaisar.Base.playerWinPrize = function (idPlayer, Title, PrizeList) {
    ...
    Elkaisar.DB.Insert(`id_to = ${idPlayer}, head = '${Title}', body=?, time_stamp = ${Math.floor(Date.now() / 1000)}`, "msg_diff", [`<div id="matrial-box-gift" style="border: none; background: none"><ul class="matrial-list">${List}</ul></div>`]);
