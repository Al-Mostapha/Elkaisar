...
class AMarket {
    ...
    sellOffer(unitPrice, Resource, quantity) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const Offers = yield ASelectFrom("*", "market_deal", Cond, [unitPrice, Resource]);
    ...
    buyOffer(unitPrice, Resource, quantity) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const SmallestOffer = yield Elkaisar.DB.ASelectFrom("*", "market_deal", Cond, [Resource]);
            // $msg_num = 0;
            const msgNum = 0;
            // $total_done = 0;
            let totalDone = 0;
    ...
    ProposeSellOffer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const CityRes = yield Elkaisar.Base.ASelectFrom("food, wood, stone, metal, coin", "city", "id_city = ? AND id_player = ?", [idCity, this.idPlayer]);
            ...
            yield Elkaisar.Base.AUpdateTable(Quary, "city", "id_city = ? AND id_player = ?", [idCity, this.idPlayer]);
    ...
    ProposeBuyOffer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fees = unitPrice * quantity * 0.75 / 100;
            yield LSaveState.saveCityState(idCity);
            const totalPayment = quantity * unitPrice + fees;
            if (totalPayment <= 0 || quantity <= 0)
                return { state: "error_2" };
            const CityCoin = yield Elkaisar.DB.ASelectFrom("food, wood, stone, metal, coin", "city", "id_city = ? AND id_player = ?", [idCity, this.idPlayer]);
