    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            var MaxPoint = `<label>أقصى نقاط هجوم يمكن الحصول عليها</label>
                            ...
                            <label>نسبة الحسول الأولى</label>
                            <input value="${JsonObject.Max[0].rate_1}" id="god-gate-rate-1"/> <hr>
                            <label>نسبة الحسول الثانية</label>
                            <input value="${JsonObject.Max[0].rate_2}" id="god-gate-rate-2"/> <hr>
                            <label>نسبة الحسول الثالثة</label>
                            <input value="${JsonObject.Max[0].rate_3}" id="god-gate-rate-3"/> <hr>
`;
    ...
    alertBox.confirm("تأكيد تعديل أقصى قوة  للبوبات", function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                rate_1  : $("#god-gate-rate-1").val(),
                rate_2  : $("#god-gate-rate-2").val(),
                rate_3  : $("#god-gate-rate-3").val()
            },
            beforeSend: function (xhr) {
