        ...
        <div id="main">
            ...
            <div id="middle">
                ...
                <div id="center-column">
                            ...
                            <div class="content" style="overflow: auto">
                                ...
                                <div id="other-list" style="width: 30%">
                                    <div id="resource-req">
                                        ...
                                        <input id="offer-server-max" type="text" name="textfield" placeholder="أقصى كمية للسيرفر"  style="margin-top: 3px"/>
                                        <input id="offer-player-max" type="text" name="textfield" placeholder="أقصى كمية للاعب"  style="margin-top: 3px"/>
                                        <br>
                                        <input id="offer-avail" type="checkbox"/><label>ظاهر</label>
                                    </div>
                                    <hr/>
                                </div>
                            </div>
                    ...
                    <hr style="display: block;width: 100%;float: none;clear: both;">
                    <div id="SEND_SERVER_OFFER">
                        <button style="display: block; margin: auto; width: 120px; height: 36px; margin-bottom: 15px;">إرسال العرض</button>
                    </div>
                    <!--
